...
GRUB_EXPORT(grub_burn_stack);
GRUB_EXPORT(grub_cipher_register);
GRUB_EXPORT(grub_cipher_unregister);
GRUB_EXPORT(grub_md_register);
GRUB_EXPORT(grub_md_unregister);
GRUB_EXPORT(grub_crypto_lookup_md_by_name);
GRUB_EXPORT(grub_crypto_memcmp);
GRUB_EXPORT(grub_crypto_autoload_hook);
GRUB_EXPORT(grub_crypto_gcry_error);
GRUB_EXPORT(grub_crypto_hmac_buffer);
