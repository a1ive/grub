...
grub_normal_add_menu_entry (int argc, const char **args,
			    const char *sourcecode, int is_snapshot, grub_menu_entry_t *pNewEntry)
{
...
#define TITLE ("VMLite VBoot (based on GRUB2 " PACKAGE_VERSION ")")
...
grub_normal_execute (const char *config, int nested, int batch)
{
  ...
  /* we need to use this file path inside vboot kernel drivers */
